...
function email_this($data)
  ...
  if(isset($_GET['id']))//if it is a form
    ...
    {
    $data_and_emailthis = $data.'<br/><p><a href="/email/?id='.get_the_ID().'" rel="nofollow" title="Email this post to your friend" style="font-weight: bold;"><img src="'.get_bloginfo('wpurl').'/wp-content/plugins/email-this/email.gif" style="border: 0px; padding: 0px; margin: 0px;" alt="Email this post"> Email this post</a></p>';    
    }
